...
Source0:        https://github.com/UZDoom/UZDoom/archive/refs/tags/%{version}.tar.gz#/uzdoom-%{version}.tar.gz
...
Source3:        setup_doom_plus_doom_ii_2715-adcdb6e-5_\(64bit\)_\(81590\).exe
...
mkdir -p %{builddir}/UZDoom-%{version}/build/
...
%conf
cd %{builddir}/UZDoom-%{version}/build/
cmake                                              \
...
%build
ninja -C %{builddir}/UZDoom-%{version}/build/
cd %{builddir}/wadfusion-master/ && yes | python wadfusion.py


%install
install -D -t %{buildroot}/%{_bindir}/                              %{builddir}/UZDoom-%{version}/build/uzdoom
install -D -t %{buildroot}/%{_datadir}/doom/                        %{builddir}/UZDoom-%{version}/build/*.pk3
install -D -t %{buildroot}/%{_datadir}/doom/fm_banks/               %{builddir}/UZDoom-%{version}/build/fm_banks/*
install -D -t %{buildroot}/%{_datadir}/doom/soundfonts/             %{builddir}/UZDoom-%{version}/build/soundfonts/*
